...
$(document).ready(function(){
	...
	$('#fileAdjuntarPsicologico').on('file1', function(event, resultado){ // Agregamos el evento al div que escuchará
		...
		$("#nombreAdjuntarPsicologico").val(resultado.nombreArchivo);
	    
	});
	 
	$('#fileAdjuntarPsicologico').on('change', function(ev){
		
		//console.log("Inicio 1");
		
	    $('#fileAdjuntarPsicologico').trigger('file1', { // Lanzamos el evento y pasamos un objeto como parametro (puede ser tambien un array).
			...
			<div class="input-group">
                <label class="input-group-btn">
                    <span class="btn btn-primary">
                        Adjuntar <input type="file" name='fileAdjuntarPsicologico' id='fileAdjuntarPsicologico' style="display: none;" >
                    </span>
                </label>
                <input type="text" id="nombreAdjuntarPsicologico" placeholder='Elegir un archivo ...' class="form-control" readonly />
                <label class="input-group-btn">
                    <span class="btn btn-default">
                        <img src="recursos/images/icons/eliminar_16x16.png" alt="Eliminar" onclick="borrarNombreArchivo('nombreAdjuntarPsicologico');"/>
                    </span>
                </label>
            </div>
		</div>
