	...
	<div class="wrapper fadeInDown">
  		<div id="formContent">
	    	...
	    	<div class="fadeIn first">
	      		<img src="recursos/images/icons/icon.svg" id="icon" alt="User Icon" />
	    	</div>
	
	    	<!-- Login Form -->
	    	<form action="<c:url value="/j_spring_security_check"/>" method="post">
	    		<input type="text" name="j_username" id="j_username" class="fadeIn second" name="login" placeholder="Ingrese su usuario">
	      		<input type="password" name="j_password" class="fadeIn third" placeholder="Ingrese su clave">
	      		<input type="submit" class="fadeIn second" value="Ingresar">
	    	</form>
